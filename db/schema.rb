...
ActiveRecord::Schema[7.1].define(version: 2024_03_28_220140) do
  ...
  create_table "bookmarks", force: :cascade do |t|
    ...
    t.index ["chirp_id"], name: "index_bookmarks_on_chirp_id"
    t.index ["user_id", "chirp_id"], name: "index_bookmarks_on_user_id_and_chirp_id", unique: true
  ...
  add_foreign_key "bookmarks", "chirps"
